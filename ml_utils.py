...
lr_pipeline = jb.load("logistic_regression_20210113.pkl.z")
mdl_lgbm = jb.load("lgbm_20210113.pkl.z")
title_vec = jb.load("title_vectorizer_20210113.pkl.z")
...
def compute_prediction(data):
    ...
    p_lr = lr_pipeline.predict_proba(feature_array)[0][1]
    p_lgbm = mdl_lgbm.predict_proba(feature_array)[0][1]

    p = 0.6*p_lr + 0.4*p_lgbm
